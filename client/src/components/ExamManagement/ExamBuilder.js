...
class ExamBuilder extends React.Component {
  ...
  componentWillMount = () => {
    ...
    this.props.profiles.forEach(pro => {
      this.state.data = [
        ...this.state.data,
        createData(
          pro.user._id,
  ...
  handleClick = (event, id, userId, pro) => {
    ...
    console.log("newSelected is:", newSelected);
    console.log("newSelectedStuId is:", newSelectedStuId);
    console.log("newSStudents are:", newSStudents);
                    ...
                    .map(n => {
                      ...
                      return (
                        <TableRow
                          hover
                          onClick={event =>
                            this.handleClick(event, n.id, n.userId, n.pro)
                          }
                          role="checkbox"
